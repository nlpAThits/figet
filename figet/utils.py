...
def plot_k(full_type_positions, full_closest_true_neighbor):
    ...
    save_plot(plt, full_type_positions, "img/full_type_cumulative.png", cumulative=True)
    save_plot(plt, full_closest_true_neighbor, "img/full_closest.png")
    save_plot(plt, full_closest_true_neighbor, "img/full_closest_cumulative.png", cumulative=True)


def save_plot(plt, data, filename, cumulative=False):
