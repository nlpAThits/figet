...
class Coach(object):
    ...
    def train(self):
        ...
        for epoch in range(1, self.args.epochs + 1):
            ...
            if epoch % 15 == 0:
                ...
                torch.save(self.model.state_dict(), f"models/update-vs-all-hyperqa-dict-{epoch}.pt")
    ...
    def set_learning_rate(self, epoch):
        ...
        """
        if epoch <= 5 or epoch > int(self.args.epochs * 0.9): # first two and last few epochs
